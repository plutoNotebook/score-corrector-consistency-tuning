...
def main(**kwargs):
    ...
    if opts.ecd:
        c.loss_kwargs = dnnlib.EasyDict(P_mean=opts.mean, P_std=opts.std, q=opts.q, c=opts.c, k=opts.k, b=opts.b, adj=opts.mapping, gamma=opts.gamma, initial=opts.initial, mu_type=opts.mu_schedule, ctm=opts.ctm, dpm_solver=opts.dpm_solver, heun=opts.heun)
    else:
